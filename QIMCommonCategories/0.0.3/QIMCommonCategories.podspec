...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "http://gitlab.corp.qunar.com/qchat/libQIMCommonCategories-iOS.git", :tag => s.version.to_s}
  ...
  s.public_header_files = "QIMCommonCategories/QIMCommonCategoriesPublicHeader.h"
